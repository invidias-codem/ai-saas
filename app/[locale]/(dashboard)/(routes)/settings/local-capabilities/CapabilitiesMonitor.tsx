...
import { Terminal, Shield, HardDrive, Zap, CheckCircle2, XCircle, Monitor, Lock } from "lucide-react";
...
export function CapabilitiesMonitor({ workspaceId }: { workspaceId: string }) {
