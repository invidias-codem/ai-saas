...
const VaultPage = () => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                setData(prev => prev ? {
                    ...
                    counts: {
                        ...prev.counts,
                        deleted: prev.counts.deleted - 1,
                        active: prev.counts.active + 1
                    }
                } : null);
            }
        } catch (error) {
    ...
    const tabs: { id: FilterType; label: string; count: number }[] = [
        ...
        { id: 'active', label: 'Active', count: data?.counts.active || 0 },
        { id: 'archived', label: 'Archived', count: data?.counts.archived || 0 },
        { id: 'deleted', label: 'Deleted', count: data?.counts.deleted || 0 },
    ];
                                ...
                                <div className="flex items-start justify-between gap-4">
                                    ...
                                    >
                                        <div className="flex items-center gap-2 mb-1">
                                            ...
                                            {conv.isDeleted && (
                                                <span className="px-2 py-0.5 text-xs rounded-full bg-red-200 text-red-600">
                                                    Deleted
                                                </span>
                                            )}
                                        ...
                                        {conv.isDeleted ? (
                                            ...
                                            <>
                                                <Button
                                                    ...
                                                    onClick={(e) => {
                                                        e.stopPropagation();
                                                        handleArchive(conv.id, conv.isArchived);
                                                    }}
                                                    disabled={actionLoading === conv.id}
                                                ...
                                                >
                                                    <Archive className={cn(
                                                        "w-4 h-4",
                                                        conv.isArchived && "text-amber-600"
                                                    )} />
                                                </Button>
                                                <Button
                                                    size="sm"
