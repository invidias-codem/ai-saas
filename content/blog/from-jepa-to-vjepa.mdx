---
title: "From JEPA to VJEPA: What We Actually Built"
description: "Engineering notes from shipping an uncertainty-aware world model on Vercel: diagonal variance, fail-closed circuit breakers, DP-SGD, and GossipSub heartbeat adaptation — with real staging validation."
publishedAt: "2026-08-27"
updatedAt: "2026-08-27"
author: "joshua-jair"
category: "ai-architecture"
tags: ["jepa", "vjepa", "dp-sgd", "gossipsub", "vercel", "onnx", "mcts", "world-model", "p2p", "libp2p", "edge-functions", "upstash", "wasi"]
ogImage: "/blog/from-jepa-to-vjepa-og.png"
---
