---
title: "Under the Hood: Migrating Genie's Memory to Supabase"
description: "A deep dive into how we re-architected Genie's memory system using Supabase and pgvector for semantic search and sub-second retrieval latency."
publishedAt: "2026-01-11"
author: "joshua-jair"
category: "ai-memory"
tags: ["supabase", "rag", "engineering", "memory", "postgres"]
featured: true
ogImage: "/blog/supabase-memory-og.png"
---
...
Mention `@Genie` in your next thread and ask, "What was the API key format we decided on last week?" Watch the magic happen.
</Callout>
