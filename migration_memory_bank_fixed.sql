-- FIXED MIGRATION: Enhanced Memory Bank Schema
-- This script drops existing functions first, then creates new tables and features
...
DROP FUNCTION IF EXISTS update_memory_count();
...
-- ============================================
-- STEP 3: Create functions (fresh, after dropping old ones)
-- ============================================
...
CREATE FUNCTION update_memory_count()
RETURNS TRIGGER AS $$
BEGIN
