...
export function KofiDonationModal() {
    ...
    return (
        <Dialog open={showKofiModal} onOpenChange={setShowKofiModal}>
            <DialogContent className="sm:max-w-md bg-slate-900 border-slate-800 text-slate-100 max-h-[90dvh] flex flex-col p-4 sm:p-6 overflow-hidden">
                <DialogHeader>
                ...
                <DialogFooter className="flex-col sm:flex-row gap-2 mt-4 pt-4 border-t border-slate-800 shrink-0">
