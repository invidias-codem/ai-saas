...
const cards = [
  {
    key: "card1",
    icon: "🧩",
    border: "border-amber-300/60 dark:border-violet-500/40",
    glow: "shadow-[0_0_24px_-8px_rgba(245,158,11,0.22)] dark:shadow-[0_0_24px_-8px_rgba(168,85,247,0.4)]",
    accent: "from-amber-400/20 to-transparent dark:from-violet-500/20 dark:to-transparent",
    badge: "bg-amber-100 text-amber-800 border-amber-200 dark:bg-violet-500/15 dark:text-violet-300 dark:border-violet-500/30",
  },
  {
    key: "card2",
    icon: "✨",
    border: "border-yellow-300/60 dark:border-sky-400/40",
    glow: "shadow-[0_0_24px_-8px_rgba(234,179,8,0.22)] dark:shadow-[0_0_24px_-8px_rgba(56,189,248,0.4)]",
    accent: "from-yellow-400/20 to-transparent dark:from-sky-500/20 dark:to-transparent",
    badge: "bg-yellow-100 text-yellow-800 border-yellow-200 dark:bg-sky-500/15 dark:text-sky-300 dark:border-sky-400/30",
  },
  {
    key: "card3",
    icon: "🧠",
    border: "border-orange-300/60 dark:border-amber-400/40",
    glow: "shadow-[0_0_24px_-8px_rgba(249,115,22,0.22)] dark:shadow-[0_0_24px_-8px_rgba(245,158,11,0.4)]",
    accent: "from-orange-400/20 to-transparent dark:from-amber-500/20 dark:to-transparent",
    badge: "bg-orange-100 text-orange-800 border-orange-200 dark:bg-amber-500/15 dark:text-amber-300 dark:border-amber-400/30",
  },
  {
    key: "card4",
    icon: "🎯",
    border: "border-amber-200/70 dark:border-emerald-400/40",
    glow: "shadow-[0_0_24px_-8px_rgba(251,191,36,0.2)] dark:shadow-[0_0_24px_-8px_rgba(16,185,129,0.4)]",
    accent: "from-amber-300/20 to-transparent dark:from-emerald-500/20 dark:to-transparent",
