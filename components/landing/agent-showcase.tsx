...
export const AgentShowcase = () => {
    ...
    return (
        <div className="w-full max-w-5xl mx-auto p-4">
                    ...
                    {(Object.values(SCENARIOS) as Scenario[]).map((s) => (
                        <button
                            ...
                            className={`
                                ...
                                ${activeScenario === s.id ? 'text-white' : 'text-gray-400 hover:text-gray-200'}
                            `}
                        >
                            {activeScenario === s.id && (
                                <motion.div
            ...
            {/* Main Showcase Card */}
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 bg-[#0f1117]/80 backdrop-blur-xl border border-white/10 rounded-3xl overflow-hidden shadow-2xl ring-1 ring-white/5">

                {/* LEFT: Input / Setup */}
                <div className="relative p-8 flex flex-col justify-between min-h-[400px] border-b lg:border-b-0 lg:border-r border-white/5 bg-gradient-to-br from-white/5 to-transparent">
                    <div>
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <div>
                                <h3 className="text-lg font-semibold text-white">{scenario.label} Agent</h3>
                        ...
                        <div className="bg-white/5 rounded-2xl p-4 border border-white/10 mb-6">
                            <div className="flex items-start gap-3">
                                ...
                                <div className="space-y-3 flex-1">
                                    <p className="text-sm text-gray-200">{scenario.userPrompt}</p>

                                    {/* Mock Attachment */}
                                    <div className="flex items-center gap-3 p-3 bg-black/40 rounded-xl border border-white/5 group cursor-pointer hover:border-indigo-500/30 transition-colors">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-[10px] text-gray-500">2.4 MB • Uploaded</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        {status === "idle" ? (
                            ...
                            >
                                <Button
                                    ...
                                    className="w-full h-14 text-lg bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500 shadow-lg shadow-indigo-900/20 rounded-xl"
                                >
                ...
                {/* RIGHT: Agent Output */}
                <div className="relative p-8 bg-black/20 flex flex-col justify-center min-h-[400px]">
                        ...
                        <div className="space-y-4">
                            {scenario.steps.map((step, idx) => (
                                ...
                                >
                                    ...
                                    <span className={`text-sm ${idx === currentStep ? 'text-indigo-200 font-medium' : 'text-gray-500'}`}>
                                        {step}
                                    </span>
                                </motion.div>
                            ))}
                            ...
                            <div className="relative z-10">
                                <div className="flex justify-between items-start mb-4">
                                    <div>
                                        ...
                                        <h4 className="text-xl font-bold text-white shadow-black drop-shadow-sm">
                                ...
                                <div className="flex gap-3">
                                    <Link href="/dashboard" className="flex-1">
                                        <Button className="w-full bg-white text-black hover:bg-gray-200 font-semibold group">
                                    ...
                                    <Button
                                        ...
                                        className="border-white/10 hover:bg-white/10 text-gray-400 hover:text-white"
                                    >
                    ...
                    {status === "idle" && (
                        <div className="flex flex-col items-center justify-center text-center opacity-40">
                            ...
                            <p className="text-sm text-gray-500">Agent is standing by...</p>
                        </div>
                    )}
                </div>
            </div>
