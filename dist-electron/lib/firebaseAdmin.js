...
exports.admin = exports.db = exports.app = void 0;
exports.isProperlyInitialized = isProperlyInitialized;
exports.getProjectId = getProjectId;
exports.reinitializeIfNeeded = reinitializeIfNeeded;
const admin = __importStar(require("firebase-admin"));
exports.admin = admin;
const buildPhase_1 = require("@/lib/runtime/buildPhase");
...
function getServiceAccountFromEnv() {
    ...
    if (serviceAccountJson) {
        try {
            ...
            if (!(0, buildPhase_1.shouldQuietBuildLogs)())
    ...
    if (projectId && clientEmail && privateKey) {
        ...
        if (projectId && !(0, buildPhase_1.shouldQuietBuildLogs)())
            console.log('[FIREBASE_ADMIN] Found projectId but missing clientEmail or privateKey');
    }
    return null;
}
...
function transformToServiceAccount(parsed) {
    return {
...
function isProperlyInitialized() {
