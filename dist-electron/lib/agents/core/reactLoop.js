 ...
 */
async function runReActLoop(userQuery, context, registry, modelName = 'gemini-2.5-flash') {
    ...
    const vertexAI = new vertexai_1.VertexAI({ project, location, googleAuthOptions });
