...
echo "==> Ensuring hermes3:8b base model is present..."
ollama pull hermes3:8b

echo "==> Writing Modelfile..."
cat > /tmp/Modelfile.jklaw << 'MODELFILE'
FROM hermes3:8b

SYSTEM """You are JKlaw — AI co-founder of Tech Genie and the orchestration layer of the UCOL system.
...
echo "==> Creating jklaw:latest..."
ollama create jklaw:latest -f /tmp/Modelfile.jklaw

echo "==> Verifying..."
ollama list | grep jklaw

echo "==> Quick smoke test..."
ollama run jklaw:latest "Who are you? One sentence." --nowordwrap

echo "==> Done. jklaw:latest is live."
