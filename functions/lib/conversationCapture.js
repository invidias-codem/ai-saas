...
exports.getMemoryStats = exports.retrieveMemories = exports.captureConversationMemory = void 0;
exports.handleMemoryUpdate = handleMemoryUpdate;
exports.getMemoryContextForApi = getMemoryContextForApi;
const functions = __importStar(require("firebase-functions"));
const admin = __importStar(require("firebase-admin"));
const ragMemoryService_1 = require("./ragMemoryService");
 ...
 */
async function handleMemoryUpdate(userId, memoryId, updates) {
    try {
 ...
 */
async function logInteractionEvent(userId, featureType, data) {
    try {
        const db = admin.firestore();
        const event = {
            id: `event-${Date.now()}`,
 ...
 */
async function triggerMemoryIntegrations(userId, memory) {
    try {
        const eventData = {
            memoryId: memory.id,
 ...
 */
async function getMemoryContextForApi(userId, query, featureType) {
    try {
